        ...
        <section className="home" id="home">
            ...
            >
                ...
                >
                    <Typography
                        textAlign="center"
                        sx={{ fontSize: { xs: '10vw', md: '5vw' }, fontFamily: 'borel, cursive' }}
                    >
                        hogar <br /> esperanza
                    </Typography>
                    <Typography  textAlign="center">
                        ...
                        personalizada y sentirse valorados y queridos. Trabajamos para mejorar su calidad de vida y
                        hacer que cada día sea una oportunidad para encontrar esperanza, alegría y propósito.
                    </Typography>
                </Stack>
            </Container>
        </section>
